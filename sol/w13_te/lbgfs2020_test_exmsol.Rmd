...
cat("$$\n")
cat("A = \\left[\n")
cat(paste0(rmddochelper::sConvertMatrixToLaTexArray(pmatAMatrix = matA, pnDigits = 4)))
cat("\\right]\n")
cat("$$")
```
...
vec_snp_b <- c("b_0", rmddochelper::vecGetVecElem(psBaseElement = "b", pnVecLen = n_nr_snp, psResult = 'latex'))
vec_res_e <- rmddochelper::vecGetVecElem(psBaseElement = "e", pnVecLen = n_nr_animal, psResult = 'latex')
mat_x <- as.matrix(tbl_all_data[,2:4])
mat_x <- cbind(rep(1, nrow(tbl_all_data)), mat_x)
cat("$$\n")
cat("y = \\left[")
cat(paste0(rmddochelper::sConvertVectorToLaTexArray(pvec_avector = vec_obs_y, pnDigits = 0)))
cat("\\right] \\text{, }\n")
cat("e = \\left[")
cat(paste0(rmddochelper::sConvertVectorToLaTexArray(pvec_avector = vec_res_e)))
cat("\\right] \\text{, }\n")
cat("b = \\left[")
cat(paste0(rmddochelper::sConvertVectorToLaTexArray(pvec_avector = vec_snp_b)))
cat("\\right] \\text{, }\n")
cat("X = \\left[")
cat(paste0(rmddochelper::sConvertMatrixToLaTexArray(pmatAMatrix =  mat_x, pnDigits = 0)))
cat("\\right]\n")
cat("$$\n")
```
...
cat("$$\n")
cat("\\hat{b} = (X^TX)^{-1}X^Ty = \\left[")
cat(paste0(rmddochelper::sConvertVectorToLaTexArray(pvec_avector = vec_hat_b, pnDigits = 3)))
cat("\\right] $$\n")
```
...
vec_obs_y <- tbl_all_data$Observation
vec_b_mu <- c("\\mu")
vec_g_bv <- rmddochelper::vecGetVecElem(psBaseElement = "g", pnVecLen = n_nr_animal, psResult = 'latex')
vec_res_e <- rmddochelper::vecGetVecElem(psBaseElement = "e", pnVecLen = n_nr_animal, psResult = 'latex')
...
cat("\\right] \\text{, }\n")
cat("b = \\left[")
cat(paste0(rmddochelper::sConvertVectorToLaTexArray(pvec_avector = vec_b_mu)))
cat("\\right] \\text{, }\n")
cat("g = \\left[")
cat(paste0(rmddochelper::sConvertVectorToLaTexArray(pvec_avector = vec_g_bv)))
cat("\\right] \\text{, }\n")
cat("X = \\left[")
cat(paste0(rmddochelper::sConvertMatrixToLaTexArray(pmatAMatrix =  mat_x, pnDigits = 0)))
cat("\\right] \\text{, }\n")
cat("Z = \\left[")
cat(paste0(rmddochelper::sConvertMatrixToLaTexArray(pmatAMatrix =  mat_z, pnDigits = 0)))
cat("\\right]\n")
cat("$$\n")
```
...
cat(" = \n")
cat("\\left[\n")
cat(paste0(rmddochelper::sConvertVectorToLaTexArray(pvec_avector = mat_sol)))
cat("\\right]\n")
cat("$$\n")
```
...
vec_b_imf <- rmddochelper::vecGetVecElem("b", 2, psResult = 'latex')
vec_u_imf <- rmddochelper::vecGetVecElem("u", n_nr_ani_imf, psResult = 'latex')
vec_e_imf <- rmddochelper::vecGetVecElem("e", n_nr_obs_imf, psResult = 'latex')
mat_x_imf <- mat_x[,2:3]
cat("$$\n")
cat("y = \\left[")
cat(paste0(rmddochelper::sConvertVectorToLaTexArray(pvec_avector = vec_y_imf, pnDigits = 2)))
cat("\\right] \\text{, }\n")
cat("b = \\left[")
cat(paste0(rmddochelper::sConvertVectorToLaTexArray(pvec_avector = vec_b_imf)))
cat("\\right] \\text{, }\n")
cat("u = \\left[")
cat(paste0(rmddochelper::sConvertVectorToLaTexArray(pvec_avector = vec_u_imf)))
cat("\\right] \\text{, }\n")
cat("e = \\left[")
cat(paste0(rmddochelper::sConvertVectorToLaTexArray(pvec_avector = vec_e_imf)))
cat("\\right] \\text{, }\n")
cat("$$\n")

cat("$$\n")
cat("X = \\left[")
cat(paste0(rmddochelper::sConvertMatrixToLaTexArray(pmatAMatrix = mat_x_imf, pnDigits = 0)))
cat("\\right] \\text{, }\n")
cat("Z = \\left[")
cat(paste0(rmddochelper::sConvertMatrixToLaTexArray(pmatAMatrix = mat_z_imf, pnDigits = 0)))
cat("\\right]\n")
cat("$$\n")
```
...
cat("$$\n")
cat("\\left[\n")
cat(paste0(rmddochelper::sConvertVectorToLaTexArray(pvec_avector = vec_uk_imf)))
cat("\\right]\n")
cat(" = \n")
cat("\\left[\n")
cat(paste0(rmddochelper::sConvertVectorToLaTexArray(pvec_avector = mat_sol_imf, pnDigits = 4)))
cat("\\right]\n")
cat("$$\n")
```
...
cat("$$B_{IMF} = \\left[")
cat(paste0(rmddochelper::sConvertVectorToLaTexArray(pvec_avector = vec_rel1, pnDigits = 4), collapse = "\n"), "\n")
cat("\\right]")
cat("$$\n")
```
...
cat("$$\n")
cat("b = \\left[")
cat(paste0(rmddochelper::sConvertVectorToLaTexArray(pvec_avector = ev, pnDigits = 2), collapse = "\n"), "\n")
cat("\\right]\n")
cat("$$\n")
```
